...
namespace ProjectDB01 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ProdutoDataTable : global::System.Data.TypedTableBase<ProdutoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProdutoRow AddProdutoRow(int Id, string descricao) {
...
namespace ProjectDB01.Database1DataSetTableAdapters {
    ...
    public partial class ProdutoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Produto] ([Id], [descricao]) VALUES (@Id, @descricao);\r\nSELECT" +
                " Id, descricao FROM Produto WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Produto] SET [Id] = @Id, [descricao] = @descricao WHERE (([Id] = @O" +
                "riginal_Id) AND ((@IsNull_descricao = 1 AND [descricao] IS NULL) OR ([descricao]" +
                " = @Original_descricao)));\r\nSELECT Id, descricao FROM Produto WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjectDB01.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, descricao FROM dbo.Produto";
